...
# Generate 18 unique random times between 1 and 18
random_times = random.sample(range(1, 19), 18)

# Process each random update with a delay of 3 seconds between each
for s in random_times:
